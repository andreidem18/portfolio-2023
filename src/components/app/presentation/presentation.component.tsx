...
} from "@/components/_shared/animations/on-scroll/from-sides";
      ...
      <div className={styles.homeContainer}>
        ...
        >
          <div className={styles.devInfo}>
            ...
            <h1 className={styles.andresName}>Andrés Mendoza</h1>
            <ul className={styles.socialList}>
              {socialDataFiltered.map((social) => (
                <li className={styles.socialItem} key={social.name}>
                  <a href={social.link} className="center" target="_blank">
                    {social.icon}
                  </a>
                </li>
              ))}
            </ul>
            <p>{translate("homeDescription")}</p>
